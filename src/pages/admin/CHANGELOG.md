...
- refactor(Companies): tweak lazy and Suspense for Widget03 
...
- feat(Companies): new `Suspense` example with Widget03
...
- refactor: Companies legend badge pill
...
###### `v1.0.8`
- refactor: Companies radio buttons, new `onRadioBtnClick()` method
...
- Companies .dropdown-menu-right temp.scss hotfix (full)
- callout.scss .chart-wrapper hotfix (full)

###### `2017.08.11`
- Bootstrap 4 beta
- Companies component (full):
