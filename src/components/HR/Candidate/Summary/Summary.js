		...
		<div className={classes.candidateImgFlex}>
			...
			<div>
				<Status cvID={cvID} vacancyID={vacancyID}>
					<Text className={classes.candidateName}>{getUserName(candidate)}</Text>
				</Status>
		...
		<div className={classes.candidateBackgroundFlex}>
			<div className={classes.candidateBackgroundItem}>
				<div className={classes.candidateInfoFlex}>
					<Text className={`${classes.candidateKey} ${classes.candidateInfoItem}`}>
						{t('EMPLOYMENT_TYPE')}
					</Text>
					<Text className={`${classes.candidateProperty} ${classes.candidateInfoItem}`}>
